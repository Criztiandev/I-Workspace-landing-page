...
=======
  variant?: 'default' | 'minimal' | 'detailed';
>>>>>>> 2e4b714dfad38883cde50ff9dfa84e69cf4d5ccd
  onComplete?: () => void;
}
...
=======
        ...
        {/* Sparkle Effects */}
        <Sparkles className="absolute -top-2 -right-2 h-6 w-6 text-blue-300/60 animate-spin" style={{ animationDuration: '3s' }} />
        <Sparkles className="absolute -bottom-2 -left-2 h-5 w-5 text-purple-300/60 animate-spin" style={{ animationDuration: '4s', animationDirection: 'reverse' }} />
>>>>>>> 2e4b714dfad38883cde50ff9dfa84e69cf4d5ccd
...
=======
        ...
        {/* Animated Rings */}
        <div className="absolute inset-0 w-40 h-40 border-2 border-transparent border-t-blue-500 rounded-full animate-spin"></div>
        <div className="absolute inset-2 w-36 h-36 border-2 border-transparent border-r-purple-500 rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '2s' }}></div>
        <div className="absolute inset-4 w-32 h-32 border-2 border-transparent border-b-cyan-500 rounded-full animate-spin" style={{ animationDuration: '3s' }}></div>
...
=======
            <div className="text-xs text-slate-400 font-mono">{currentProgress}%</div>
          </div>
        </div>
...
<<<<<<< HEAD
            ...
            ></div>
=======
            <div className="absolute -top-1 -bottom-1 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full blur-sm" style={{ width: `${currentProgress}%` }}></div>
>>>>>>> 2e4b714dfad38883cde50ff9dfa84e69cf4d5ccd
          </div>
        </div>
      )}
