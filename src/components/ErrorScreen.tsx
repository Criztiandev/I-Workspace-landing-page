        ...
        <div className="w-full max-w-lg">
            ...
            <div className="relative p-8 sm:p-10">
              ...
              <div className="flex justify-center mb-8">
                <div className="relative">
                  ...
                  {/* Sparkle Effects */}
                  <Sparkles className="absolute -top-2 -right-2 h-6 w-6 text-red-300/60 animate-spin" style={{ animationDuration: '3s' }} />
                  <Sparkles className="absolute -bottom-1 -left-1 h-4 w-4 text-orange-300/60 animate-spin" style={{ animationDuration: '4s', animationDirection: 'reverse' }} />
                </div>
              </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-500 text-sm">
              Error Code: <span className="font-mono text-slate-400">ERR_500</span> • 
              <span className="ml-2">Need help? <button className="text-blue-400 hover:text-blue-300 underline transition-colors">Contact Support</button></span>
            </p>
          </div>
        </div>
      </div>
